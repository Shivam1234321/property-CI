		...
		<div class="row">
			<div class="col-lg-12">
				<div class="invoice-list-table w-100">
                    <h3 class="mb-30 text-center color-secondary wow slideInDown animated">All Payments And Invoices List</h3>
                    <table class="w-100">
                        <thead class="wow slideInUp animated">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>UKJ81712</td>
                                <td>Sale</td>
                                <td>Sale a Sisvas family appartment in green road</td>
                                <td>$51200</td>
                                <td>- $51200</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>UKJ81712</td>
                                <td>Instalment</td>
                                <td>Paid instalment of GA321 land</td>
                                <td>$25000</td>
                                <td>- $25000</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>UKJ81712</td>
                                <td>Sale</td>
                                <td>2 Story house sale in bk Residential Area</td>
                                <td>$123500</td>
                                <td>- $123500</td>
                            </tr>
                            <tr>
