			...
			<div class="row">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light px-0">
						<a class="navbar-brand" href="index.html"><img class="nav-logo" src="images/logo/logo-white.png" alt="logo"></a>
							...
							<ul class="navbar-nav mx-auto">
											...
											<div class="row">
												<div class="col-xl-3 col-lg-3">
													<ul>
														...
														<li><a class="dropdown-item" href="index-2.html">Investment</a></li>
														<li><a class="dropdown-item" href="index-3.html">3D Slider</a></li> 
														<li><a class="dropdown-item" href="index-4.html">Agency</a></li>
														<li><a class="dropdown-item" href="index-17.html">Video Search</a></li>
														<li><a class="dropdown-item" href="index-21.html">Video Scroll Nav</a></li>
													</ul>
												</div>
												<div class="col-xl-3 col-lg-3">
													<ul>
														<li><a class="dropdown-item" href="index-5.html">Map Search Box</a></li> 
														<li><a class="dropdown-item" href="index-6.html">Banner Search Box</a></li>
														<li><a class="dropdown-item" href="index-7.html">Search on Map</a></li>
														<li><a class="dropdown-item" href="index-8.html">Search on Banner</a></li>
														<li><a class="dropdown-item" href="index-18.html">Search on video</a></li>
														<li><a class="dropdown-item" href="index-22.html">World Map View</a></li>
													</ul>
												</div>
												<div class="col-xl-3 col-lg-3">
													<ul>
														<li><a class="dropdown-item" href="index-9.html">Header Search Map</a></li>
														<li><a class="dropdown-item" href="index-10.html">Search on Map 2</a></li> 
														<li><a class="dropdown-item" href="index-11.html">Search on Map 3</a></li> 
														<li><a class="dropdown-item" href="index-12.html">Property Search Scroll</a></li>
														<li><a class="dropdown-item" href="index-19.html">Search on Video 2</a></li>
														<li><a class="dropdown-item" href="#">Coming Soon</a></li>
													</ul>
												</div>
												<div class="col-xl-3 col-lg-3">
													<ul>
														<li><a class="dropdown-item" href="index-13.html">Featured Property</a></li>
														<li><a class="dropdown-item" href="index-14.html">Property Search List</a></li>
														<li><a class="dropdown-item" href="index-15.html">Agent Search</a></li>
														<li><a class="dropdown-item" href="index-16.html">Agent Search 2</a></li>
														<li><a class="dropdown-item" href="index-20.html">Map Scroll Nav</a></li>
														<li><a class="dropdown-item" href="#">Coming Soon</a></li>
													</ul>
												</div>
											</div>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu shadow">
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="#">Property</a>
											<ul class="dropdown-menu shadow">
											    ...
											    <li><a class="dropdown-item" href="property-thumbnail-full-width.html">Property Thumbnail</a></li>
											    <li><a class="dropdown-item" href="property-grid-left-sidebar.html">Property Grid Left Sidebar</a></li>
											    <li><a class="dropdown-item" href="property-list-left-sidebar.html">Property List Left Sidebar</a></li>
											    <li><a class="dropdown-item" href="property-thumbnail-left-sidebar.html">Property Thumbnail Left Sidebar</a></li>
											    <li><a class="dropdown-item" href="property-grid-right-sidebar.html">Property Grid Right Sidebar</a></li>
											    <li><a class="dropdown-item" href="property-list-right-sidebar.html">Property List Right Sidebar</a></li>
											    <li><a class="dropdown-item" href="property-thumbnail-right-sidebar.html">Property Thumbnail Right Sidebar</a></li>
											</ul>
										</li>
										<li><a class="dropdown-item" href="single-property.html">Single Property</a></li>
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="#">Booking Page</a>
											<ul class="dropdown-menu shadow">
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Agents</a>
									<ul class="dropdown-menu shadow">
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="#">Agents</a>
											<ul class="dropdown-menu shadow">
											    <li><a class="dropdown-item" href="agent-style-1-grid-left-sidebar.html">Agents One Grid Left</a></li>
											    <li><a class="dropdown-item" href="agent-style-1-grid-right-sidebar.html">Agents One Grid Right</a></li>
											    <li><a class="dropdown-item" href="agent-style-2-grid-left-sidebar.html">Agents Two Grid Left</a></li>
											    <li><a class="dropdown-item" href="agent-style-2-grid-right-sidebar.html">Agents Two Grid Right</a></li>
											    <li><a class="dropdown-item" href="agent-style-1-list-left-sidebar.html">Agents One List Left</a></li>
											    <li><a class="dropdown-item" href="agent-style-1-list-right-sidebar.html">Agents One List Right</a></li>
											    <li><a class="dropdown-item" href="agent-style-2-list-left-sidebar.html">Agents Two List Left</a></li>
											    <li><a class="dropdown-item" href="agent-style-2-list-right-sidebar.html">Agents Two List Right</a></li>
											</ul>
										</li>
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="#">Agency</a>
											<ul class="dropdown-menu shadow">
											    <li><a class="dropdown-item" href="agency-grid-left-sidebar.html">Agency Grid Left Sidebar</a></li>
											    <li><a class="dropdown-item" href="agency-grid-right-sidebar.html">Agency Grid Right Sidebar</a></li>
											    <li><a class="dropdown-item" href="agency-list-left-sidebar.html">Agency List Left Sidebar</a></li>
											    <li><a class="dropdown-item" href="agency-list-right-sidebar.html">Agency List Right Sidebar</a></li>
											</ul>
										</li>
									</ul>
								</li>
											...
											<div class="row">
												...
												<div class="col-xl-3 col-lg-3">
													<ul>
														...
														<li><a class="dropdown-item" href="dashboard/offers.html">Offers</a></li>
														<li><a class="dropdown-item" href="dashboard/tax-info.html">Tax Information</a></li>
														<li><a class="dropdown-item" href="dashboard/settings.html">Settings</a></li>
														<li><a class="dropdown-item" href="dashboard/featured-item.html">Featured Item</a></li>
													</ul>
												</div>
												<div class="col-xl-3 col-lg-3">
													<ul>
														<li><a class="dropdown-item" href="dashboard/dashboard.html">Dashboard</a></li>
														<li><a class="dropdown-item" href="dashboard/analytics.html">Analytics</a></li> 
														<li><a class="dropdown-item" href="dashboard/customers.html">Customers</a></li> 
														<li><a class="dropdown-item" href="dashboard/message.html">Message</a></li>
														<li><a class="dropdown-item" href="dashboard/comment.html">Comment</a></li>
														<li><a class="dropdown-item" href="dashboard/review.html">Review</a></li>
														<li><a class="dropdown-item" href="dashboard/booking-request.html">Booking Request</a></li>
														<li><a class="dropdown-item" href="dashboard/listing-property.html">Listing Property</a></li>
														<li><a class="dropdown-item" href="dashboard/favorite-property.html">Favorite Property</a></li>
													</ul>
												</div>
												<div class="col-xl-3 col-lg-3">
													<ul>
														<li><a class="dropdown-item" href="dashboard/purchased-property.html">Purchased Property</a></li>
														<li><a class="dropdown-item" href="dashboard/submit-property.html">Submit Property</a></li>
														<li><a class="dropdown-item" href="dashboard/personal-info.html">Personal Information</a></li>
														<li><a class="dropdown-item" href="dashboard/profile-setting.html">Profile Setting</a></li>
														<li><a class="dropdown-item" href="dashboard/payment-invoice.html">Payment & Invoice</a></li>
														<li><a class="dropdown-item" href="dashboard/change-password.html">Change Password</a></li>
														<li><a class="dropdown-item" href="dashboard/social-media-setting.html">Social Media</a></li>
														<li><a class="dropdown-item" href="dashboard/recent-item.html">Recent Item</a></li>
														<li><a class="dropdown-item" href="#">Coming Soon</a></li>
													</ul>
												</div>
											</div>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-7 col-xl-6 wow slideInLeft animated">
				<div class="side-title mb-30 pr-30">
					...
					<h2 class="title mb-20 color-secondary">We're is this business since <span class="color-primary">1981</span> and we provide the best real estate services</h2>
				</div>
				<p>Vestibulum suspendisse ridiculus. Hac duis cursus orci quis mus. Volutp sodale primis litora ad consequat cras sapien quam Feugiat cubilia Sagittis lacus dignis Feugiat ultricie curabitur aliquet sapien elementum scelerisque lacinia consectet odio ad sollicitudin lectus venenatis lacus.</p>
				<ul class="list-half icon-primary my-20 d-table">
					<li><i class="fa fa-check"></i> High Quality Property</li>
					<li><i class="fa fa-check"></i> 100% Satisfaction Guarantee</li>
					<li><i class="fa fa-check"></i> Quality Control System</li>
					<li><i class="fa fa-check"></i> unlimited real estate property</li>
					<li><i class="fa fa-check"></i> Accurate dealing Processes</li>
					<li><i class="fa fa-check"></i> Professional and Qualified</li>
				</ul>
				<p>Augue nisi nec primis molestie mollis quam convallis rhoncus taciti urna curabit arcu pulvinar Sed feugiat nullam nonum element montes nec faucibus Rhoncus. Viverra curae torquent penatibus tempus nullam dignissim.</p>
				<a class="btn btn-primary mt-30" href="#">Read More</a>
			</div>
			<div class="col-md-12 col-lg-5 col-xl-6 wow animated slideInRight">
		        ...
		        <div class="position-relative">
		        	<img src="images/about/2.jpg" alt="Image not found!">
		        	<div class="bg-primary position-absolute color-white" style="display: inline-block; width: 180px; height: auto; padding: 40px 20px; bottom: -35px; left: 50px;">
		        		...
		        		<a class="btn-round mt-20" href="#"><i class="fa fa-angle-right"></i></a>
		        	</div>
		        </div>
			</div>
		</div>
...
<!-- About us End
==================================================================-->
<!-- Page inner Banner Start
==================================================================-->
<div class="wow slideInUp animated" style="background: url(images/background/16.jpg) center center /cover; padding-top: 80px;">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-4">
				<div class="bg-white py-50 px-30 wow slideInLeft animated">
					<h3 class="color-secondary mb-20">Search Bitter From Anyplace</h3>
					<p>Dignissim mollis vehicula quisque rhoncus auctor risus bibendum lacinia curae; mollis Montes facilisis dictum, malesuada aptent malesuada velit quisque scelerisque.</p>
					<a class="btn btn-primary position-relative mt-20" href="#">Search Now</a>
				</div>
			</div>
		</div>
	</div>
</div>
<!-- Page inner Banner End
==================================================================-->
<!-- Top Agencies Start
==================================================================-->
<section>
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-6">
				<div class="side-title pb-30 wow slideInLeft animated">
			...
			<div class="col-md-12 col-lg-12">
				<div class="row">
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary wow slideInLeft animated">
							<div class="row">
					...
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary wow slideInDown animated">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
					...
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary wow slideInUp animated">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
					...
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary wow slideInRight animated">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
...
<section class="p-0 bg-light">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 col-lg-6">
				<div class="row">
					<div class="experience position-relative wow slideInUp animated" style="margin-top: 90px">
						<img src="images/others/20.jpg" alt="Image not found!">
						<div class="years text-center color-secondary">
							<h2><span class="display-1 d-table mx-auto color-secondary">39</span> Years of Experience</h2>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-12 col-lg-6">
				<div class="row">
					<div class="best-help py-80 bg-primary px-30 color-white wow slideInRight animated">
						<h2 class="color-secondary mb-30">We Help You To Find The Best Property For The Future.</h2>
						<p>Magnis molestie taciti platea laoreet aenean, gravida commodo. Ullamcorper senectus Pulvinar Accumsan potenti dictumst. Nulla ante nostra augue lacus arcu morbi metusy nonummy rhoncus. Duis dui placerat lectus feugiat.</p>
						<p class="mt-15">Dictumst platea faucibus viverra luctus aliquam porttitor tortor massa interd Consequ facilisi vestibulum. Vel sit dapibus magna amet. Pharetra pulvinar pede lectus ornarey varius. Turpis suscipit faucibus nec facilisi. Quisque interdul sociosqu nullam placerat elementum ad ultricies habitasse vel viverra urna class tellus. Natoque aptent aliquam lacinia, penatibus facilisi rutrum mollis vel, sapien dui cras, adipiscing adipiscin Curae volutpat netus gravida fames cras, ligula tellus. Enim cras mauris facilisis scelerisque pharetra risus in rhoncus et duis ridiculus magnis et donec.</p>
						<div style="width: 250px; height: auto;">
							<img src="images/others/signature.gif" alt="Images not found!">
							<span>Robert Louise - Founder</span>
						</div>
					</div>
				</div>
			</div>
...
<!--Neighborhoods Start
==================================================================-->
<section class="bg-light wow slideInDown animated">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-12">
				<div class="main-title w-50 mx-auto d-table text-center mb-30">
					...
					<span class="sub-title">Sociis eget dui hendrerit urna felis euismod viverra. Inceptos habitasse augue quisque facilisis per. Nibh justo massa suscipit.</span>
				</div>
			</div>
			<div class="col-md-12 col-lg-12">
				<div class="owl-carousel neighborhoods owl-dots-none mt-30 owl-loaded owl-drag">
					<div class="neighborhoods-thumbnail">
						...
						<h6 class="place-name py-5 px-30 bg-secondary position-absolute color-white">Brooklyn</h6>
						<div class="bg-secondary py-10 px-20 color-white icon-primary d-table w-100">
							<ul>
								<li><span class="mr-5"><i class="fa fa-map-marker" aria-hidden="true"></i></span> Listings : 92</li>
								<li><span class="mr-5"><i class="fa fa-usd" aria-hidden="true"></i></span> Price : $1200 - $50000</li>
							</ul>
						</div>
					</div>
					<div class="neighborhoods-thumbnail">
						<a href="#"><img src="images/explore/2.jpg" alt="images"></a>
						<h6 class="place-name py-5 px-30 bg-secondary position-absolute color-white">Washington</h6>
						<div class="bg-secondary py-10 px-20 color-white icon-primary d-table w-100">
							<ul>
								<li><span class="mr-5"><i class="fa fa-map-marker" aria-hidden="true"></i></span> Listings : 95</li>
								<li><span class="mr-5"><i class="fa fa-usd" aria-hidden="true"></i></span> Price : $1500 - $99999</li>
							</ul>
						</div>
					</div>
					<div class="neighborhoods-thumbnail">
						<a href="#"><img src="images/explore/3.jpg" alt="images"></a>
						<h6 class="place-name py-5 px-30 bg-secondary position-absolute color-white">Cincinnati</h6>
						<div class="bg-secondary py-10 px-20 color-white icon-primary d-table w-100">
							<ul>
								<li><span class="mr-5"><i class="fa fa-map-marker" aria-hidden="true"></i></span> Listings : 82</li>
								<li><span class="mr-5"><i class="fa fa-usd" aria-hidden="true"></i></span> Price : $1000 - $30000</li>
							</ul>
						</div>
					</div>
					<div class="neighborhoods-thumbnail">
						<a href="#"><img src="images/explore/4.jpg" alt="images"></a>
						<h6 class="place-name py-5 px-30 bg-secondary position-absolute color-white">Maxico</h6>
						<div class="bg-secondary py-10 px-20 color-white icon-primary d-table w-100">
							<ul>
								<li><span class="mr-5"><i class="fa fa-map-marker" aria-hidden="true"></i></span> Listings : 75</li>
								<li><span class="mr-5"><i class="fa fa-usd" aria-hidden="true"></i></span> Price : $1500 - $75000</li>
							</ul>
						</div>
					</div>
					<div class="neighborhoods-thumbnail">
						<a href="#"><img src="images/explore/5.jpg" alt="images"></a>
						<h6 class="place-name py-5 px-30 bg-secondary position-absolute color-white">Rochester</h6>
						<div class="bg-secondary py-10 px-20 color-white icon-primary d-table w-100">
							<ul>
								<li><span class="mr-5"><i class="fa fa-map-marker" aria-hidden="true"></i></span> Listings : 56</li>
								<li><span class="mr-5"><i class="fa fa-usd" aria-hidden="true"></i></span> Price : $1200 - $50000</li>
							</ul>
						</div>
					</div>
					<div class="neighborhoods-thumbnail">
						...
						<h6 class="place-name py-5 px-30 bg-secondary position-absolute color-white">Alabama</h6>
						<div class="bg-secondary py-10 px-20 color-white icon-primary d-table w-100">
							<ul>
								<li><span class="mr-5"><i class="fa fa-map-marker" aria-hidden="true"></i></span> Listings : 73</li>
								<li><span class="mr-5"><i class="fa fa-usd" aria-hidden="true"></i></span> Price : $1000 - $70000</li>
							</ul>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-7">
				<div class="bg-white p-50 wow slideInLeft animated">
					<div class="row">
						<div class="col-md-10 col-lg-10">
							<div class="side-title mb-30">
								<span class="small-title color-primary position-relative line-primary">Want A Better Life?</span>
								<h2 class="title mb-20 color-secondary">Buy A Property and Lead A Happy Life.</h2>
								<p>Luctus posuere facili eros auctor lacinia litora. Convall aptent nisy parturient scelerisq. Nullam fringil condimen integer mauris lacus aliquam, quam massa lobortis commod proin magna.</p>
							</div>
								...
								<ul>
									<li>
										...
										<div class="d-table">
											...
											<p>Consectetu cum nunc pede porttitor, nibh suspend socios congue. Pede lectus habitasse consequat conval natoque ligula neque ridiculus mauris.</p>
										</div>
									</li>
									<li class="mt-30">
			...
			<div class="w-100">
				<div class="fact-counter achievement text-center py-50 px-30 position-absolute bg-secondary wow slideInUp animated">
		            <div class="row">
		              <div class="col-md-6 col-lg-6">
		                <div class="counter count wow">
		                  <div class="counter-point d-inline-block">
		                    <h2 class="count-num color-primary" data-speed="3000" data-stop="1250">0</h2>
		                  </div>
		              ...
		              <div class="col-md-6 col-lg-6">
		                <div class="counter count wow mt-sm-30">
		                  <div class="counter-point d-inline-block">
		                    <h2 class="count-num color-primary" data-speed="3000" data-stop="72">0</h2>
		                  </div>
		              ...
		              <div class="col-md-6 col-lg-6">
		                <div class="counter count wow mt-30">
		                  <div class="counter-point d-inline-block">
		                    <h2 class="count-num color-primary" data-speed="3000" data-stop="150">0</h2>
		                  </div>
		              ...
		              <div class="col-md-6 col-lg-6">
		                <div class="counter count wow mt-30">
		                  <div class="counter-point d-inline-block">
		                    <h2 class="count-num color-primary" data-speed="3000" data-stop="583">0</h2>
		                  </div>
...
==================================================================-->
<section class="overlay-secondary overflow-hidden" style="background: url(images/background/memphis.png);">
	<div class="container">
		<div class="row">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-md-4 col-lg-6 wow animated slideInLeft">
				<div class="footer-logo"><a href="index.html"><img class="nav-logo" src="images/logo/logo-white.png" alt="Footer Logo"></a></div>
			</div>
			<div class="col-sm-8 col-md-8 col-lg-6 wow animated slideInRight">
				<ul class="social-media-2 border-white large color-white-a float-right">
					<li class="mr-20 color-white"><strong>Follow Us:</strong></li>
					<li><a href="#"><i class="fa fa-facebook"></i></a></li>
					<li><a href="#"><i class="fa fa-twitter"></i></a></li>
					<li><a href="#"><i class="fa fa-behance"></i></a></li>
					<li><a href="#"><i class="fa fa-instagram"></i></a></li>
				...
				<div class="footer-widget color-gray-light mt-sm-30">
					...
					<div class="widget-content color-primary">
						<ul class="widget-contact">
							<li>
								Call
								<span class="color-white">+(844) 234-567-800</span>
							</li>
							<li>
								Email
								<span class="color-white">support@yourdomail.com</span>
							</li>
							<li>
								Free Consultation
