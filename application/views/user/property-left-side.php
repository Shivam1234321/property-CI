...
.property-cost.color-white.list-half.w-100 ul li {
			...
			<div class="col-md-12 col-lg-12 wow slideInUp animated">
				<form class="adbanced-form-two amenities-list border-top-1-gray">
	  				<div class="row">
						...
						<div class="form-group mb-0 pb-15 col-lg-3 col-md-6 col-12">
							<div class="price_range">
								<div class="price-filter">
									  <span><input id="filter_sqft" type="text" name="price" value="20000; 80000" /></span>
								</div>
							</div>
						</div>
						<div class="form-group mb-0 pb-15 col-lg-3 col-md-6 col-12">
						...
						<div class="form-group col-md-6 col-lg-3">
							<a class="color-secondary position-relative plus-minus pl-20 d-block y-center" data-toggle="collapse" href="#Collapse1" role="button" aria-expanded="false" aria-controls="Collapse1">Amenities</a>
						</div>
						<div class="col-md-12 col-lg-12">
							<div class="collapse" id="Collapse1">
								<div class="row">
									<div class="form-group col-lg-12 mb-0">
										<ul class="list-bottom amenities select-option">
				                            <li>
