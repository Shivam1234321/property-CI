...
<div class="page-banner overlay-black" style="padding: 150px 0">
	<div class="container h-100">
		<div class="row h-100 align-items-center">
			<div class="col-lg-12">
				<h1 class="page-banner-title color-primary">Error</h1>
		...
		<div class="row h-100 align-items-center">
			<div class="col-lg-12">
				<div class="error-info text-center w-50">
					...
					<h2 class="py-20 color-secondary wow slideInDown animated">Opps! Page Not Found</h2>
					<p class=" wow slideInUp animated">Sed justo bibendum rutrum nec placerat Sapien tempus sociis. Fames vulputate ante. Dictum nunc lobortis. Vel id urna id hymenaeos, fames est nullam auctor nonummy imperdiet congue. Urna luctus facilisis.</p>
					<a class="btn btn-primary mt-30 wow slideInUp animated" href="index.html">Back to Home</a>
				</div>
			</div>
		</div>
	</div>
