...
<div class="page-banner overlay-black" style="padding: 150px 0">
	<div class="container h-100">
		<div class="row h-100 align-items-center">
			<div class="col-lg-12">
				<h1 class="page-banner-title color-primary">Submit Property</h1>
...
<section class="submit-property bg-light">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<form class="property-submit-form" action="#" method="post">
					<div class="property-info bg-white py-40 px-30 wow slideInDown animated">
						<div class="row">
							<div class="form-group col-lg-6">
								<label>Property Title</label>
								<input class="form-control bg-gray" type="text" name="property-title">
							</div>
							<div class="form-group col-lg-6">
								<label>Property Type</label>
								<div class="select-wrapper position-relative">
									<select class="select form-control bg-gray">
							...
							<div class="form-group col-lg-6">
								<label>Price</label>
								<input class="form-control bg-gray" type="text" name="price">
							</div>
							<div class="form-group col-lg-6">
								<label>Area</label>
								<input class="form-control bg-gray" type="text" name="area">
							</div>
							<div class="form-group col-lg-6">
								<label>Rooms</label>
								<div class="select-wrapper position-relative">
							...
							<div class="form-group col-lg-12">
								...
								<textarea class="form-control bg-gray" rows="7"></textarea>
							</div>
							<div class="col-lg-12">
					...
					<div class="property-location mt-30 bg-white py-40 px-30 wow slideInUp animated">
						<div class="row">
							<div class="form-group col-lg-6">
								<label>Address</label>
								<input class="form-control bg-gray" type="text" name="address">
							</div>
							<div class="form-group col-lg-6">
								<label>County/State</label>
								<input class="form-control bg-gray" type="text" name="state">
							</div>
							<div class="form-group col-lg-6">
								<label>City</label>
								<input class="form-control bg-gray" type="text" name="city">
							</div>
							<div class="form-group col-lg-6">
								<label>Zip</label>
								<input class="form-control bg-gray" type="text" name="zip">
							</div>
							<div class="form-group col-lg-6">
								<label>Neighborhood</label>
								<input class="form-control bg-gray" type="text" name="neighborhood">
							</div>
							<div class="form-group col-lg-6">
								<label>Country</label>
								<div class="select-wrapper position-relative">
							...
							<div class="form-group col-lg-12">
								...
								<div id="map" class="canvas" style="height: 400px"></div>
							</div>
							<div class="form-group col-lg-4">
								<label>Latitude (for Google Maps)</label>
								<input class="form-control bg-gray" type="text" name="latitude">
							</div>
							<div class="form-group col-lg-4">
								<label>Longitude (for Google Maps)</label>
								<input class="form-control bg-gray" type="text" name="longitude">
							</div>
							<div class="form-group col-lg-4">
								<label>Google Map Street View</label>
								<div class="select-wrapper position-relative">
									<select class="select form-control bg-gray">
										<option>Street View 1</option>
										<option>Street View 2</option>
										<option>Street View 3</option>
										<option>Street View 4</option>
										<option>Street View 5</option>
										<option>Street View 6</option>
										<option>Street View 7</option>
									</select>
								</div>
							</div>
							<div class="col-lg-12">
					...
					<div class="property-info mt-30 bg-white py-40 px-30 wow slideInDown animated">
						<div class="row">
							<div class="form-group col-lg-4">
								...
								<input class="form-control bg-gray" type="text" name="property-id">
							</div>
							<div class="form-group col-lg-4">
								<label>Area Size</label>
								<input class="form-control bg-gray" type="text" name="area-size">
							</div>
							<div class="form-group col-lg-4">
								<label>Size Prefix</label>
								<input class="form-control bg-gray" type="text" name="size-prefix">
							</div>
							<div class="form-group col-lg-4">
								<label>Land Area</label>
								<input class="form-control bg-gray" type="text" name="land-area">
							</div>
							<div class="form-group col-lg-4">
								<label>Land Area Size Postfix</label>
								<input class="form-control bg-gray" type="text" name="land-area-postfix">
							</div>
							<div class="form-group col-lg-4">
								<label>Bedrooms</label>
								<input class="form-control bg-gray" type="text" name="bedrooms">
							</div>
							<div class="form-group col-lg-4">
								<label>Bathrooms</label>
								<input class="form-control bg-gray" type="text" name="bathrooms">
							</div>
							<div class="form-group col-lg-4">
								<label>Garages</label>
								<input class="form-control bg-gray" type="text" name="garages">
							</div>
							<div class="form-group col-lg-4">
								<label>Garages Size</label>
								<input class="form-control bg-gray" type="text" name="garages-size">
							</div>
							<div class="form-group col-lg-4">
								<label>Built Year</label>
								<input class="form-control bg-gray" type="text" name="built-year">
							</div>
							<div class="form-group col-lg-4">
								<label>video URL</label>
								<input class="form-control bg-gray" type="text" name="video-link">
							</div>
							<div class="form-group col-lg-4">
								<label>360° Virtual Tour</label>
								<input class="form-control bg-gray" type="text" name="virtual-tour">
							</div>
							<div class="form-group col-lg-12">
								<label>Amenities</label>
								<ul class="list-bottom amenities select-option p-0">
		                            <li>
					...
					<div class="property-info property-media mt-30 bg-white py-40 px-30 wow slideInUp animated">
						<div class="row">
							...
							<div class="col-lg-12">
								<ul class="attached-photos p-30 bg-gray d-table">
									<li class="attached-photo">
										<img src="images/property/1.jpg" alt="image">
										<span class="color-white"><i class="fa fa-trash"></i></span>
									</li>
									<li class="attached-photo mt-sm-30">
										<img src="images/property/2.jpg" alt="image">
										<span class="color-white"><i class="fa fa-trash"></i></span>
									</li>
									<li class="attached-photo mt-md-30">
							...
							<div class="form-group col-lg-12">
								<div class="drag-drop bg-gray px-30 py-40 text-center mt-15">
									<span class="fa fa-upload color-primary"></span>
									<h4 class="inner-title mt-15">Drag & Drop Images Here</h4>
								</div>
							</div>
							<div class="col-lg-12">
								<button class="btn btn-primary">Back</button>
