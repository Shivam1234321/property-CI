...
<div class="page-banner overlay-black" style="padding: 150px 0">
	<div class="container h-100">
		<div class="row h-100 align-items-center">
			<div class="col-lg-12">
				<h1 class="page-banner-title color-primary">Booking Form</h1>
			...
			<div class="col-lg-12">
				<div class="bg-white px-30 py-40 shadow w-75 mx-auto">
					<form action="#" method="post">
						<h3 class="color-secondary line-bottom pb-15 mb-20 wow slideInDown animated">Fill the form for booking now</h3>
						<div class="row">
							<div class="form-group col-md-12 col-lg-6 wow slideInRight animated">
								<input type="text" class="form-control bg-gray" placeholder="First Name*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInLeft animated">
								<input type="text" class="form-control bg-gray" placeholder="Last Name*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInLeft animated">
								<input type="text" class="form-control bg-gray" placeholder="Your Company*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInRight animated">
								<input type="email" class="form-control bg-gray" placeholder="Email Address*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInRight animated">
								<input type="text" class="form-control bg-gray" placeholder="Phone Number*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInLeft animated">
								<input type="text" class="form-control bg-gray" placeholder="Subject*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInLeft animated">
								<input type="text" class="form-control bg-gray" placeholder="Selling Agent Name*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInRight animated">
								<input type="text" class="form-control bg-gray" placeholder="Realty Company*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInRight animated">
								<input type="text" class="form-control bg-gray" placeholder="Realtor Address*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInLeft animated">
								<input type="text" class="form-control bg-gray" placeholder="City*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInLeft animated">
								<input type="text" class="form-control bg-gray" placeholder="State/Province*">
							</div>
							<div class="form-group col-md-12 col-lg-6 wow slideInRight animated">
								<input type="text" class="form-control bg-gray" placeholder="Post Code*">
							</div>
							<div class="form-group col-md-12 col-lg-12 wow slideInUp animated">
								<textarea class="form-control bg-gray" rows="7" placeholder="Type Comments...(Optional)"></textarea>
							</div>
