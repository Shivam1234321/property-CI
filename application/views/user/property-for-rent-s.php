...
<head>
    ...
    <!-- Title -->
    <title>Filter Search - Real Estate</title>
    ...
    <style>
        ...
        .text-thumbnail.text-center.bg-white:hover {
...
.btn.btn-primary.w-100.mt-md-15 {
...
==================================================================-->
    <div class="main" style="padding: 40px 0;">
        <div class="container">
		    ...
		    <h3 class="city-search">property for rent in York, North Yorkshire</h3>
            <div class="py-40">
	<div class="container">
