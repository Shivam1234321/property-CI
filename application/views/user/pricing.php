...
<div class="page-banner overlay-black" style="padding: 150px 0">
	<div class="container h-100">
		<div class="row h-100 align-items-center">
			<div class="col-lg-12">
				<h1 class="page-banner-title color-primary">Pricing Table</h1>
...
<section class="pricing">
	<div class="container">
		<div class="row">
			<div class="col-lg-4 wow slideInRight animated">
				<div class="pricing-item bg-secondary color-gray-light text-center py-40 px-30">
					<h2 class="mb-30 color-white"><sup class="color-primary">$</sup>49<sub class="color-gray-light">/ mo</sub></h2>
					<h4 class="inner-title color-white py-15 bg-primary">Silver Membership</h4>
					<ul class="my-30 pricing-list">
			...
			<div class="col-lg-4 wow slideInUp animated">
				<div class="pricing-item bg-primary color-white text-center py-40 px-30 mt-md-30">
					<h2 class="mb-30 color-white"><sup class="color-secondary">$</sup>69<sub class="color-secondary">/ mo</sub></h2>
					<h4 class="inner-title color-primary py-15 bg-white">Gold Membership</h4>
					<ul class="my-30 pricing-list">
			...
			<div class="col-lg-4 wow slideInLeft animated">
				<div class="pricing-item bg-secondary color-gray-light text-center py-40 px-30 mt-md-30">
					<h2 class="mb-30 color-white"><sup class="color-primary">$</sup>99<sub class="color-gray-light">/ mo</sub></h2>
					<h4 class="inner-title color-white py-15 bg-primary">Platinum Membership</h4>
					<ul class="my-30 pricing-list">
						<li>10 Property Listings</li>
						<li>30 Days Availability</li>
						<li>One User Access</li>
						<li>Feature Properties</li>
						<li>Suggest People and Advartise</li>
						<li>Top Listing On Search</li>
						<li>Live Support 24/7 Days</li>
					</ul>
					<a href="#" class="btn btn-white">Buy Now</a>
